...
public class LocalAirtableRepository<T extends AirtableRecord> implements Repository<T, String> {
  private LocalAirtableJpaRepository<T> jpaRepository;
  // If this class is needed, consider implementing the following wrapper methods:
